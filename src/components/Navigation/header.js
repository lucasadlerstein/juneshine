/** @jsx jsx */
import { jsx, Button, Link, Container, Flex, Styled} from 'theme-ui'
...
export const Header = ({announcement, rightBtn}) => {
  ...
  return (
    <>
      ...
      <Flex sx={{ backgroundColor: 'white', p: 4, position: "fixed", top: "0", left: "0", right: "0", width: "100%", zIndex: "3000",  display: ["flex", "flex","flex"], zIndex: '300'}}>
        <Container>
            ...
            <Flex sx={{justifyContent: "flex-end", alignItems: "center"}}>
              {rightBtn ? (
                  ...
                  <Styled.a onClick={openCart} sx={{px: 4, position: 'relative'}}>
                    <span sx={{position: 'absolute', fontSize: '12px', borderRadius: "100%", height: '20px', width: '20px', backgroundColor: 'primary', color: 'dark', display: 'flex', alignItems: 'center', justifyContent: 'center'}} style={{right: "10px", top: "-4px"}}>
                      {quantity}
                    </span>
