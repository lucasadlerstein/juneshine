...
import ResultComponentProbabilities from "./ResultComponentProbabilities"
...
const QuizComponentProbabilities = ({items, data, answers, numberOfSteps}) => {
                            ...
                            (step === -2) ? (
                                ...
                                (step === -1) ? <EmailKlaviyo /> : (
                                    ...
                                    (step >= data.length) ? (
                                        ...
                                        <ResultComponentProbabilities items={items} answers={answers} />
...
export default QuizComponentProbabilities;